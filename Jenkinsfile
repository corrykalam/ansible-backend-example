                    ...
                    sshPublisher(
                        publishers: [
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        execCommand: 'cd /home/ansman/ansible && ansible-playbook -i hosts stagging-backend.yml',
                                        execTimeout: 120000,
                                    )
                                ]
                            )
                    ...
                    sshPublisher(
                        publishers: [
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        execCommand: 'cd /home/ansman/ansible && ansible-playbook -i hosts fullstack-backend.yml',
                                        execTimeout: 120000,
                                    )
                                ]
                            )
